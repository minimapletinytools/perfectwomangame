...
public class XbonePLM
{
	...
	{
		//TODO save
        ManagerManager.Log("XbonePLM.cs: SUSPENDING");
	...
	void ResourceAvailabilityChangedEvent(bool aConstrained)
	{
        ...
        ManagerManager.Log("XbonePLM.cs: RESOURCES CHANGED " + aConstrained);
