...
{
    public static Dictionary<ZigJointId,Windows.Kinect.JointType> sJointTypeMap = new Dictionary<ZigJointId,Windows.Kinect.JointType>()
    {
        {ZigJointId.LeftShoulder,Windows.Kinect.JointType.ShoulderLeft},
        {ZigJointId.LeftElbow,Windows.Kinect.JointType.ElbowLeft},
        {ZigJointId.LeftHip,Windows.Kinect.JointType.HipLeft},
        {ZigJointId.LeftKnee,Windows.Kinect.JointType.KneeLeft},
        {ZigJointId.LeftAnkle,Windows.Kinect.JointType.AnkleLeft},
        {ZigJointId.RightShoulder,Windows.Kinect.JointType.ShoulderRight},
        {ZigJointId.RightElbow,Windows.Kinect.JointType.ElbowRight},
        {ZigJointId.RightHip,Windows.Kinect.JointType.HipRight},
        {ZigJointId.RightKnee,Windows.Kinect.JointType.KneeRight},
        {ZigJointId.RightAnkle,Windows.Kinect.JointType.AnkleRight},
	...
	public void update()
	{
        ...
        foreach(var body in data)
        {
            if (mIsTracking && body.TrackingId == mTrackingId)
            {
                ...
                ZigTrackedUser tu = new ZigTrackedUser((int)mTrackingId);
